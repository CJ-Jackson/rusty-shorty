...
impl AddUserForm {
    pub async fn as_validated<T: IsUsernameTakenAsync>(&self, service: &T) -> AddEditUserResult {
        AddEditUserResult(
            async {
...
pub struct AddEditUserResult(pub Result<AddUserValidated, AddUserError>);
